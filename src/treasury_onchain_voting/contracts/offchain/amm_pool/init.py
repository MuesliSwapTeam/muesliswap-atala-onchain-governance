...
from contracts.onchain.tally import tally_auth_nft
...
from contracts.onchain.amm_pool import (
    amm_pool,
    pool_nft,
    lp_token,
)
...
def main(
    ...
    pool_state_datum = amm_pool.PoolState(
        im_pool_params=amm_pool.ImmutablePoolParams(
            token_a=token_a,
            token_b=token_b,
        ...
        up_pool_params=amm_pool.UpgradeablePoolParams(
            fee=amm_pool.Fraction(3, 1000),
            auth_nft=Token(
